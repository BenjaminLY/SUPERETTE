...
public class ArticlePromo52 extends ArticleAbstrait<Integer> {
	
	private int quantiteMini;
	private float reduction;
	
	public ArticlePromo52(Integer code, String designation, float pu, int quantiteMini, float reduction) {
