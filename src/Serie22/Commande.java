...
public class Commande {
	...
	public Commande(Vector<LigneDeCommande> cde, DateUser dateCde, int numCde) {
		this.cde= cde;
	...
	public LigneDeCommande retournerAvecIndice(int indice) { // Retourne la ldc de l'indice en entrée
