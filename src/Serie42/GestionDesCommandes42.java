...
public class GestionDesCommandes42 implements MesInterfaces.InterfaceGestion<TableDesCommandes42,TableDesArticles42> {
	
	public void menuGeneral(TableDesCommandes42 tabCde, TableDesArticles42 tabArt) throws Abandon {
		int choix;
		do {
			choix= menuChoix();
			switch (choix) {
	...
	public void ajouter(TableDesCommandes42 tabCde, TableDesArticles42 tabArt) throws Abandon {
	...
	public void supprimer(TableDesCommandes42 tabCde, TableDesArticles42 tabArt) throws Abandon {
		if (tabCde.taille() != 0) { 
	...
	public void afficher(TableDesCommandes42 tabCde, TableDesArticles42 tabArt) throws Abandon {
		if (tabCde.taille() != 0) { 
			Commande42 cde= selectionCommande(tabCde);
			if (cde != null) 
	...
	public void editer(TableDesCommandes42 tabCde, TableDesArticles42 tabArt) throws Abandon {
		if (tabCde.taille() != 0) { 
			Commande42 cde= selectionCommande(tabCde); 
			if (cde != null) {
				GestionUneCommande42 guc= new GestionUneCommande42();
	...
	public void afficherToutesLesCommandes(TableDesCommandes42 tabCde, TableDesArticles42 tabArt) {
		if (tabCde.taille() != 0) ES.affiche(tabCde.toString(tabArt));
		else ES.affiche("** Aucune commande **\n"); 
	}
	
	public void facturer(TableDesArticles42 tabArt, TableDesCommandes42 tabCde) throws Abandon {
		if (tabCde.taille() != 0) { 
			Commande42 cde= selectionCommande(tabCde);
			if (cde != null)
				ES.affiche("\n" + cde.facturer(tabArt) + "\n");
