...
public class TableDesArticles42 implements MesInterfaces.InterfaceStructure<ArticleAbstrait<Integer>,Integer> {
	...
	public TableDesArticles42() {
		...
		ArticleAbstrait<Integer> a2= new Article42(4,"CARTE RESEAU",24.7F);
		ArticleAbstrait<Integer> a3= new ArticlePromo42(5,"CLE USB SUPER 32GB",12F, 5, 30F);
		ArticleAbstrait<Integer> a4= new Article42(12,"BOITE 100CD",75.5F);
		ArticleAbstrait<Integer> a5= new Article42(18,"MEMOIRE FLASH",17F);
	...
	public void supprimer(ArticleAbstrait<Integer> art, TableDesCommandes42 tabCde) {
	...
	public void supprimer(Integer code, TableDesCommandes42 tabCde) {
